...
if (!$status && $errno != 404) {
  ...
  //$addrs2    = $addrsChar > 15 ? substr($data['alamat'], 15, 15) : "";
  //$addrs3    = $addrsChar > 30 ? substr($data['alamat'], 30, 15) : "";
  //$addrs4    = $addrsChar > 45 ? substr($data['alamat'], 45, 15) : "";
  $cif       = $data['no_cif'];
  $tlp       = $data['no_tlp'];
  ...
  //} else {
    ...
    //$printer->text(sprintf('%-15.15s %1s %14s', "Dealer", ":", formatText($notes, 'left', 14) ."\n"));
    ...
    $printer->text("$line3\n");
    //$printer->text(sprintf('%-2.2s %8s %6s %5s %5s', 'No', 'Curr', 'Amount', 'Rate', 'Total'));
    //$printer->text(sprintf('%-8.8s %6s %5s %8s', ' Curr', 'Amount', 'Rate', '   Total'));
    //$printer->text("\n");
    //$printer->text("$line3");
