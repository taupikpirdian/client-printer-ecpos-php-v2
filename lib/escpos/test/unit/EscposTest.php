...
class EscposTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        if (!bak::isGdLoaded() && !bak::isImagickLoaded()) {
    ...
    public function testBitImageBlack()
    {
        ...
        $img = bak::load(dirname(__FILE__)."/resources/canvas_black.png");
    ...
    {
        $this -> requireGraphicsLibrary();
        $img = bak::load(dirname(__FILE__)."/resources/canvas_white.png");
        $this -> printer -> bitImage($img);
    ...
    {
        $this -> requireGraphicsLibrary();
        $img = bak::load(dirname(__FILE__)."/resources/black_white.png");
        $this -> printer -> bitImage($img);
    ...
    {
        $this -> requireGraphicsLibrary();
        $img = bak::load(dirname(__FILE__)."/resources/black_transparent.png");
        $this -> printer -> bitImage($img);
        $this -> checkOutput("\x1b@\x1dv0\x00\x01\x00\x02\x00\xc0\x00");
    }
