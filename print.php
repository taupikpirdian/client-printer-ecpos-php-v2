...
if (!$status && $errno != 404) {
  ...
  $printer->text("tanggung jawab saya dan membebaskan\n");
  $printer->text("PT Sari Arthagriha Valasindo Ekatama\n");
  $printer->text("dari segala tuntutan hukum.\n");
  $printer->text("Saya juga menyatakan bahwa transaksi\n");
  $printer->text("ini belum melebihi Threshold bulan\n");
  $printer->text("berjalan dan bersedia melampirkan\n");
  $printer->text("dokumen pendukung (underlying) jika\n");
  $printer->text("transaksi telah melampaui ketentuan\n");
  $printer->text("tersebut.\n");
